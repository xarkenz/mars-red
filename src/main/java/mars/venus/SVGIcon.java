...
public class SVGIcon implements Icon {
    ...
    /**
     * Create a new <code>SVGIcon</code> from a URL and initial dimensions.
     *
     ...
     *
     * @param component A <code>Component</code> to get properties useful for painting (not used).
     ...
     * an SVG image to the raw {@link BufferedImage} instead of a file format. Since <code>BufferedImage</code>
    ...
    private static class SVGToBufferedImageTranscoder extends ImageTranscoder {
         ...
         *
         * @return The image, or <code>null</code> if no previous transcode operation has been done.
         */
         ...
         * @return A blank ARGB <code>BufferedImage</code> with the specified width and height.
         */
        @Override
