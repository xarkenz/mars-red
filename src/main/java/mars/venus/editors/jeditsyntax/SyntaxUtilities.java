 ...
 */
    ...
    */
       public static SyntaxStyle[] getCurrentSyntaxStyles()
      {
         ...
         styles[Token.NULL]     = Application.getSettings().getEditorSyntaxStyleByPosition(Token.NULL);
         styles[Token.COMMENT1] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.COMMENT1);
         styles[Token.COMMENT2] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.COMMENT2);
         styles[Token.KEYWORD1] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.KEYWORD1);
         styles[Token.KEYWORD2] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.KEYWORD2);
         styles[Token.KEYWORD3] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.KEYWORD3);
         styles[Token.LITERAL1] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.LITERAL1);
         styles[Token.LITERAL2] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.LITERAL2);
         styles[Token.LABEL]    = Application.getSettings().getEditorSyntaxStyleByPosition(Token.LABEL);
         styles[Token.OPERATOR] = Application.getSettings().getEditorSyntaxStyleByPosition(Token.OPERATOR);
         styles[Token.INVALID]  = Application.getSettings().getEditorSyntaxStyleByPosition(Token.INVALID);
         styles[Token.MACRO_ARG]= Application.getSettings().getEditorSyntaxStyleByPosition(Token.MACRO_ARG);
         return styles;
      }
