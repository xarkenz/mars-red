...
//   	   JPanel jp = new JPanel(new FlowLayout(FlowLayout.LEFT));
   	    ...
   	    try {
   			  BufferedImage im =  ImageIO.read( 
   					  getClass().getResource(Application.IMAGES_PATH +"datapath.png") );
...
//      	   JPanel jp = new JPanel(new FlowLayout(FlowLayout.LEFT));
      	    ...
      	    try {
      			  BufferedImage im =  ImageIO.read( 
      					  getClass().getResource(Application.IMAGES_PATH +figure) );
       ...
       private void createActionObjects() {
           ...
           try{
               runAssembleAction = new RunAssembleAction(mainUI, "Assemble",
                       new ImageIcon(tk.getImage(cs.getResource(Application.IMAGES_PATH +"Assemble22.png"))),
